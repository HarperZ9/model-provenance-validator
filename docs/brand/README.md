# Model Provenance Validator Brand Assets

This directory contains the public README artwork for Model Provenance Validator.

- Hero image: `model-provenance-validator-hero.png`
